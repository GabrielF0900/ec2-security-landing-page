...
**O que é:** Orquestrador de infraestrutura cloud com provisionamento seguro e automatizado de servidor web (EC2) na AWS.

**Problema Resolvido:** Eliminar configuração manual de servidores, garantir segurança de rede e automatizar deployment com User Data scripts.

**Stack e AWS:** AWS EC2 • Security Groups • IAM • Linux • Apache • User Data • CloudFormation (Diagrama)

**Resultado Prático:** 100% de automação no provisionamento, acesso seguro isolado por IP, escalabilidade imediata e zero downtime em deploys.
